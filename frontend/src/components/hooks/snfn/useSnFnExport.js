...
export function useSnFnExport({ paginatedData, groupByWorkstation, codeDescMap }) {
    ...
    }, [paginatedData, groupByWorkstation, codeDescMap]);
    ...
    }, [paginatedData, groupByWorkstation]);
  ...
  const exportOptions = useMemo(() => [
    { id:'exportCsv', onClick:handleExportCSV, label:'Export CSV', disabled:exportCooldown },
    { divider:true, id:'d1' },
    { id:'exportJson', onClick:handleExportJSON, label:'Export JSON', disabled:exportCooldown },
